...
const double MIN_SAFE_DISTANCE_FRONT = 0.05; // set alarm if anything is within 0.5m of the front of robot
const double MIN_SAFE_DISTANCE_LEFT = 0.05;
const double MIN_SAFE_DISTANCE_RIGHT = 0.05;
const double MIN_SAFE_DISTANCE_RIGHT_45 = 0.05;
const double MIN_SAFE_DISTANCE_RIGHT_30 = 0.05;
const double MIN_SAFE_DISTANCE_LEFT_45 = 0.05;
const double MIN_SAFE_DISTANCE_LEFT_30 = 0.05;
